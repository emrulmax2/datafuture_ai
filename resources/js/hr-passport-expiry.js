            ...
            columns: [
                ...
                },
                {
                    ...
                    formatter(cell, formatterParams) {                        
                        ...
                        btns += '<button data-id="' +cell.getData().id +'" data-tw-toggle="modal" data-tw-target="#sendPassportExpireMailModal" type="button" title="Send reminder email" class="edit_btn inline-flex items-center justify-center w-9 h-9 rounded-lg bg-soft text-soft-text hover:bg-primary hover:text-white transition-colors ml-1"><i data-lucide="mail-check" class="w-4 h-4"></i></button>';
                        btns += '<button data-id="' +cell.getData().id +'" data-tw-toggle="modal" data-tw-target="#viewPassportExpireMailsModal" title="View sent emails" class="delete_btn inline-flex items-center justify-center w-9 h-9 rounded-lg border border-slate-200 text-slate-500 hover:text-primary hover:border-primary transition-colors ml-1"><i data-lucide="list-ordered" class="w-4 h-4"></i></button>';
