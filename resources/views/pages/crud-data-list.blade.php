...
@section('subhead')
    <title>CRUD Data List - London Churchill College</title>
@endsection
                            ...
                            <td class="w-40">
                                <div class="flex">
                                    ...
                                    <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                        <img alt="London Churchill College" class="tooltip rounded-full" src="{{ asset('build/assets/images/' . $faker['images'][1]) }}" title="Uploaded at {{ $faker['dates'][0] }}">
                                    </div>
                                    <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                        <img alt="London Churchill College" class="tooltip rounded-full" src="{{ asset('build/assets/images/' . $faker['images'][2]) }}" title="Uploaded at {{ $faker['dates'][0] }}">
                                    </div>
                                </div>
                            </td>
                            <td>
