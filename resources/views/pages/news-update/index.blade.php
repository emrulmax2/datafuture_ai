...
@section('subcontent')
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        <h2 class="text-lg font-medium mr-auto">News & Events</h2>
    ...
    <div class="intro-y box lg:mt-5">
        <div class="flex items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400">
            <h2 class="font-medium text-base mr-auto">News & Updates</h2>
            <a href="{{ route('news.updates.create') }}" class="btn btn-primary shadow-md ml-auto">Add New</a>
        </div>
        <div class="p-5">
            ...
            <div class="overflow-x-auto scrollbar-hidden">
                <div id="newsUpdatesList" class="mt-5 table-report table-report--tabulator"></div>
            </div>
        </div>
    </div>
...
@section('script')
    @vite('resources/js/news-updates.js')
@endsection