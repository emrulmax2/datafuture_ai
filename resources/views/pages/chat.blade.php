...
@section('subhead')
    <title>Chat - London Churchill College</title>
@endsection
            ...
            <div class="tab-content">
                ...
                <div id="friends" class="tab-pane" role="tabpanel" aria-labelledby="friends-tab">
                    ...
                    <div class="chat__user-list overflow-y-auto scrollbar-hidden pr-1 pt-1">
                        ...
                        <div class="cursor-pointer box relative flex items-center p-5 mt-5">
                            <div class="w-12 h-12 flex-none image-fit mr-1">
                                <img alt="London Churchill College" class="rounded-full" src="{{ asset('build/assets/images/' . $fakers[3]['photos'][0]) }}">
                                <div class="w-3 h-3 bg-success absolute right-0 bottom-0 rounded-full border-2 border-white dark:border-darkmode-600"></div>
                            </div>
                            <div class="ml-2 overflow-hidden">
                                <div class="flex items-center">
                        ...
                        <div class="cursor-pointer box relative flex items-center p-5 mt-5">
                            <div class="w-12 h-12 flex-none image-fit mr-1">
                                <img alt="London Churchill College" class="rounded-full" src="{{ asset('build/assets/images/' . $fakers[4]['photos'][0]) }}">
                                <div class="w-3 h-3 bg-success absolute right-0 bottom-0 rounded-full border-2 border-white dark:border-darkmode-600"></div>
                            </div>
                            <div class="ml-2 overflow-hidden">
                                <div class="flex items-center">
