...
<html lang="en" class="">
    ...
    <body style="margin:0; background-color: white; color:rgb(30, 41, 59); padding: 30px;">
        <div style="font-size:24px;  margin-top:10px">
            <span style="">Birthday List</span> <span style="float:right;">London Churchill College</span>
        </div>
                    ...
                    <table style="width: 100%;" class="table table-striped">
                        <thead style="font-size:12px;">
                            <tr>
                                ...
                                <th data-priority="2" scope="col">Works No</th>
                                <th data-priority="3" scope="col">Gender</th>
                                <th data-priority="4" scope="col">Date of birth</th>
                                <th data-priority="5" scope="col">Age</th>
                            </tr>
                        </thead>
