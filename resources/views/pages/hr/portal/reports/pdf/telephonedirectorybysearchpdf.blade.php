...
<html lang="en" class="">
    ...
    <body style="margin:0; background-color: white; color:rgb(30, 41, 59); padding: 30px;">
        <div style="font-size:24px;  margin-top:10px">
            <span style="">Employee Telephone Directory</span> <span style="float:right;">London Churchill College</span>
        </div>
                    ...
                    <table style="width: 100%;" class="table table-striped">
                        <thead style="font-size:12px;">
                            <tr>
                                ...
                                <th data-priority="2" scope="col">Telephone</th>
                                <th data-priority="3" scope="col">Mobile</th>
                                <th data-priority="4" scope="col">Email</th>
                            </tr>
                        </thead>
