        ...
        <div class="card" style="margin-top: 20px; width:100%;">
            <div class="card-body">
                <div class="card-title">
                    <div style="float:left; width: 40%; font-size:14px; font-family:Roboto-Bold">Visa Expiry Report</div>
                    <div style="clear:both"></div>
                        ...
                        <table style="width: 100%;" class="table table-striped">
                            <thead style="font-family:Roboto-Bold;font-size:12px;">
                                <tr>
                                    ...
                                    <th data-priority="2" scope="col">Work Permit Number</th>
                                    <th data-priority="3" scope="col">Work Permit Expiry Date</th>
                                    <th data-priority="4" scope="col">Status</th>
                                </tr>
                            </thead>
                            <tbody style="font-family:Roboto-Regular;font-size:9px;">
                                ...
                                <tr>
                                    <td>{{ $item['name'] }}</td>
                                    <td>{{ $item['workpermit_number'] }}</td>
                                    <td>{{ $item['workpermit_expire'] }}</td>
                                    <td>{{ $item['workpermit_days'] }}</td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
