...
@section('subcontent')
    <div class="intro-y flex flex-col sm:flex-row items-center mt-5">
        <h2 class="text-lg font-medium mr-auto">Remittance Payment Details</h2>
    ...
    <div class="intro-y box p-5 mt-5">
        ...
        <div class="overflow-x-auto scrollbar-hidden">
            <div id="agentRemittPaymenDetailstsListTable" data-transactionid="{{ $transaction_id }}" class="mt-5 table-report table-report--tabulator"></div>
        </div>
    </div>
    <!-- END: HTML Table Data -->
...
@section('script')
    @vite('resources/js/agent-management-payment-details.js')
@endsection