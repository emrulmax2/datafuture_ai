            ...
            <div class="flex flex-col lg:flex-row border-b border-slate-200/60 dark:border-darkmode-400 pb-5 -mx-5">
                <div class="flex flex-1 px-5 items-center justify-center lg:justify-start">
                    <div class="w-20 h-20 sm:w-24 sm:h-24 flex-none lg:w-32 lg:h-32 image-fit relative">
                        <img alt="London Churchill College" class="rounded-full" src="{{ (isset($student->photo) && !empty($student->photo) && Storage::disk('s3')->exists('public/applicants/'.$student->applicant_id.'/'.$student->photo) ? Storage::disk('s3')->url('public/applicants/'.$student->applicant_id.'/'.$student->photo) : \App\Support\Avatar::initials($student->first_name.' '.$student->last_name)) }}">
