        ...
        <div class="col-span-12 lg:col-span-8 2xl:col-span-9">
            ...
            <div class="intro-y box lg:mt-5">
                <div class="flex items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400">
                    <h2 class="font-medium text-base mr-auto">Roles List</h2>
                    <button data-tw-toggle="modal" data-tw-target="#addRoleModal" type="button" class="add_btn btn btn-primary shadow-md mr-0">Add New Role</button>
                </div>
                <div class="p-5">
