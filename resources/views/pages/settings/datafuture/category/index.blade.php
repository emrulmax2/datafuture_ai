        ...
        <div class="col-span-12 lg:col-span-8 2xl:col-span-9">
            ...
            <div class="intro-y box lg:mt-5">
                <div class="flex items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400">
                    <h2 class="font-medium text-base mr-auto">DF Field Categories</h2>
                    <button data-tw-toggle="modal" data-tw-target="#addSettingsModal" type="button" class="add_btn btn btn-primary shadow-md ml-auto">Add New Category</button>
                </div>
                <div class="p-5">
