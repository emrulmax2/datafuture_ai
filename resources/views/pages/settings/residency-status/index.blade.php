        ...
        <div class="col-span-12 lg:col-span-8 2xl:col-span-9">
            ...
            <div class="intro-y box lg:mt-5">
                <div class="flex items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400">
                    <h2 class="font-medium text-base mr-auto">{{ $subtitle }} List</h2>
                ...
                <div class="p-5">
                    ...
                    <div class="overflow-x-auto scrollbar-hidden">
                        <div id="residencyStatusTableId" class="mt-5 table-report table-report--tabulator"></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <form method="POST" action="#" id="addForm" enctype="multipart/form-data">
                <div class="modal-content">
                    <div class="modal-header">
                        <h2 class="font-medium text-base mr-auto">Add {{$subtitle}}  </h2>
                    ...
                    <div class="modal-body">
                        <div>
                            <div>
                                <label for="name" class="form-label">{{$subtitle}} <span class="text-danger">*</span></label>
    ...
    <div id="editModal" class="modal" data-tw-backdrop="static" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <form method="POST" action="#" id="editForm">
                <div class="modal-content">
                    <div class="modal-header">
                        <h2 class="font-medium text-base mr-auto flex">Edit {{ $subtitle }} <i data-loading-icon="oval"  class="w-4 h-4 mt-2 ml-2 editLoading"></i></h2>
                        <a data-tw-dismiss="modal" href="javascript:;">
                            <i data-lucide="x" class="w-5 h-5 text-slate-400"></i>
                        </a>
                    </div>
