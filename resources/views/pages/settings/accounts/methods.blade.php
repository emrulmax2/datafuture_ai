...
@section('subcontent')
        ...
        <div class="col-span-12 lg:col-span-8 2xl:col-span-9">
            ...
            <div class="intro-y box lg:mt-5">
                <div class="flex items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400">
                    ...
                    <button data-tw-toggle="modal" data-tw-target="#addMethodModal" type="button" class="add_btn btn btn-primary shadow-md ml-auto">Add New Method</button>
                </div>
                <div class="p-5">
    ...
    <!-- BEGIN: Add Modal -->
    <div id="addMethodModal" class="modal" data-tw-backdrop="static" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <form method="POST" action="#" id="addMethodForm" enctype="multipart/form-data">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div>
                            <label for="method_name" class="form-label">Method <span class="text-danger">*</span></label>
                            <input id="method_name" type="text" name="method_name" class="form-control w-full">
    ...
    <!-- END: Add Modal -->
    <!-- BEGIN: Edit Modal -->
    <div id="editMethodModal" class="modal" data-tw-backdrop="static" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <form method="POST" action="#" id="editMethodForm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div>
                            <label for="edit_method_name" class="form-label">Method <span class="text-danger">*</span></label>
                            <input id="edit_method_name" type="text" name="method_name" class="form-control w-full">
                            <div class="acc__input-error error-method_name text-danger mt-2"></div>
                        </div>
                    </div>
                    <div class="modal-footer">
