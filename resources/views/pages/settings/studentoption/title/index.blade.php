...
<div class="relative">
    <div class="flex flex-col sm:flex-row sm:items-end xl:items-start">
        ...
        <div class="flex mt-5 sm:mt-0">
            ...
            <button data-tw-toggle="modal" data-tw-target="#titleImportModal" type="button" class="import_btn btn btn-sm btn-outline-secondary shadow-md ml-2"><i data-lucide="navigation-2" class="w-4 h-4 mr-1"></i> Import</button>
        </div>
    </div>
