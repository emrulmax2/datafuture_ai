...
@section('subcontent')
    <div class="intro-y flex flex-col md:flex-row items-center mt-1 md:mt-8">
        <div class="flex flex-row justify-center md:justify-normal items-center gap-2 flex-wrap mb-4 md:mb-0 w-full">
            <h2 class="text-lg font-medium text-center md:text-left">Invoices</h2>
        </div>
        <div class="md:ml-auto md:w-full flex flex-wrap sm:flex-row gap-2 justify-end">
            <a href="{{ route('university.claims') }}" class="btn btn-facebook text-white shadow-md ml-auto"><i data-lucide="arrow-left" class="w-4 h-4 mr-2"></i>Bank to Search</a>
        </div>
    </div>
    <div class="intro-y box p-5 mt-5">
        ...
        <div class="overflow-x-auto scrollbar-hidden">
            <div id="universityInvoiceListTable" class="mt-5 table-report table-report--tabulator"></div>
        </div>
    </div>
...
@section('script')
    ...
    @vite('resources/js/accounts-university-invoice-list.js')
@endsection
