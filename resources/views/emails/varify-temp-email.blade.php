            	...
            	<tr>
            		<td>
            			<div class="text" style="padding: 0 2.5em; text-align: center;">
                            <h3><strong>Dear {{ $name }}</strong></h3>
            				<h3>
                                We got a request to change your email address <strong>{{ $oldEmail }}</strong> to <strong>{{ $newEmail }}</strong>.
            				    To change and activate your new email address please click on the verify button.
                            </h3>
