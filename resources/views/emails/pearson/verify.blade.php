      ...
      <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
          ...
          <td valign="middle" class="hero bg_white" style="padding: 2em 0 4em 0;">
            <table>
            	<tr>
            		<td>
            			<div class="text" style="padding: 0 2.5em; text-align: center; color:#000;">

							<h3>{!! $student->registration_no !!} </h3>
							<h3>{!! $student->full_name !!}</h3>

							<p>The "No" option was selected for the awarding body's personal information due to the following reason:</p>

							<p style="font-weight: bold;">{!! $studentAwardingBody->remarks !!}
							</p>
            			</div>
            		</td>
            	</tr>
