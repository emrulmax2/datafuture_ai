...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('student_consents', function (Blueprint $table) {
            $table->bigInteger('created_by')->unsigned()->nullable()->change();
            $table->bigInteger('student_user_id')->unsigned()->after('status')->nullable();
    ...
    public function down()
    {
        Schema::table('student_consents', function (Blueprint $table) {
            ...
            $table->dropForeign('student_consents_student_user_id_foreign');
