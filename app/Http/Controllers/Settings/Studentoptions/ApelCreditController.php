...
use App\Exports\ApelCreditExport;
use App\Imports\ApelCreditImport;
...
class ApelCreditController extends Controller
{
    ...
    {
        return Excel::download(new ApelCreditExport(), 'apelcredit.csv');        
    }

    public function import(Request $request) {
        $file = $request->file('file');
        
        Excel::import(new ApelCreditImport(),$file);
